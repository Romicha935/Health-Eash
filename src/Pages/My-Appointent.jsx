      ...
      {appointments.length === 0 ? (
        ...
        <div className="grid gap-4">
          {appointments.map((a, idx) => (
            <div key={idx} className="border p-4 rounded shadow flex items-center gap-10">
              {/* Doctor Image */}
              <img src={a.doctor.image} alt={a.doctor.name} className="w-44 h-48 object-contain bg-green-100 rounded" />
